...
void Texture::loadFromFile(const char* p_path) {
...
glm::vec3 Texture::getColor(glm::vec3& point, glm::vec3 vertices[3], glm::vec3 uv[3]) {
...
glm::vec3 Texture::getBarycentric(glm::vec3& point, glm::vec3 vertices[3]) {
